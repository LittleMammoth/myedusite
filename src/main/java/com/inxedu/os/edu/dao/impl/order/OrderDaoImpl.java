...
public class OrderDaoImpl extends GenericDaoImpl implements OrderDao {
	...
	public int selectUserIdByOrderId(String  outTradeNo) {
		return this.selectOne("OrderMapper.selectUserIdByOrderId", outTradeNo);
	}
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.inxedu.os.edu.dao.order.OrderDao#selectUserIdByOrderId(com.inxedu.os.edu.entity.order.Order)
	 */
