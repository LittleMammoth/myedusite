...
Source Server         : 116.85.40.162_3306
Source Server Version : 50722
Source Host           : 116.85.40.162:3306
Source Database       : lemonkt

Target Server Type    : MYSQL
Target Server Version : 50722
File Encoding         : 65001

Date: 2018-10-12 09:36:03
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='文章信息表';
...
CREATE TABLE `edu_course_favorites` (
  ...
  PRIMARY KEY (`ID`),
  KEY `user_id` (`USER_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='收藏';
...
CREATE TABLE `edu_course_note` (
  ...
  KEY `USER_ID` (`USER_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='笔记信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='课程播放记录(学习记录)';
...
-- ----------------------------
INSERT INTO `edu_msg_system` VALUES ('1', '2015-08-31 09:31:27', '2018-10-10 00:40:00', '欢迎来到因酷教育,希望你们能愉快的学习<br />', '2');
...
CREATE TABLE `edu_order` (
  ...
  `pay_status` char(1) NOT NULL COMMENT '类型0待付款 1已付款',
  `payment_type` char(1) NOT NULL COMMENT '支付方式:1.支付宝',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '变更时间',
  `alipay_id` varchar(50) DEFAULT NULL COMMENT '支付宝支付订单id',
  `pay_msg` varchar(200) DEFAULT NULL COMMENT '支付宝异步回调参数',
  PRIMARY KEY (`id`)
...
CREATE TABLE `edu_praise` (
  ...
  `ADD_TIME` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='所有的点赞表';
...
CREATE TABLE `edu_questions` (
  ...
  `ADD_TIME` datetime DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='问答';
...
CREATE TABLE `edu_questions_comment` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='问答评论';
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='问答标签';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='网站统计cpu、磁盘、网络带宽使用率';
...
CREATE TABLE `edu_statistics_day` (
  ...
  PRIMARY KEY (`ID`),
  KEY `STATISTICS_TIME` (`STATISTICS_TIME`)
) ENGINE=InnoDB AUTO_INCREMENT=1611 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='网站统计日数据';
...
INSERT INTO `edu_statistics_day` VALUES ('1610', '2018-10-09 00:00:00', '0', '2018-10-10 00:10:00', '0', '0', '16', '14');
...
CREATE TABLE `edu_user` (
  ...
  `IS_MEMBER` varchar(1) DEFAULT '0' COMMENT '是否会员(0不是1是)',
  PRIMARY KEY (`USER_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='学员表';

-- ----------------------------
-- Records of edu_user
-- ----------------------------
INSERT INTO `edu_user` VALUES ('1', '18911893513', 'lmx193@163.com', '3c5ef8ed366124eb3dd39b79b5ecdc6f', null, null, '0', '0', '2015-05-15 01:20:52', '1', null, null, '0', '1', null, '0');
INSERT INTO `edu_user` VALUES ('2', '13661164223', 'lmx193@162.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-05-15 01:24:41', '1', null, null, '0', '1', null, '0');
INSERT INTO `edu_user` VALUES ('3', '13661164224', 'lmx1943@163.com', '96e79218965eb72c92a549dd5a330112', '小星星', '小少爷', '1', '24', '2015-05-15 01:26:41', '1', '/images/upload/customer/20150910/1441866820099.jpg', null, '0', '1', null, '0');
INSERT INTO `edu_user` VALUES ('4', '18911893512', 'lmingxing@inxedu.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-05-15 02:41:11', '1', null, null, '0', '1', null, '0');
INSERT INTO `edu_user` VALUES ('5', '13661164225', 'limingxing@inxedu.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-05-15 02:42:34', '1', null, '/images/upload/image/20150512/1431402426251.jpg', '0', '1', null, '0');
INSERT INTO `edu_user` VALUES ('6', '18201604788', '916033995@qq.com', '8ed2638c342f2878cbb86b44395124c0', 'lucky', 'goddess', '1', '17', '2015-05-22 06:28:42', '1', '/images/upload/customer/20150910/1441527777887.jpg', null, '0', '0', '2016-03-21 11:50:09', '0');
INSERT INTO `edu_user` VALUES ('7', '13161090129', 'demo@inxedu.com', '96e79218965eb72c92a549dd5a330112', 'inxedu', '因酷教育', '1', '10', '2015-05-25 09:55:48', '1', '/images/upload/customer/20151204/1449196673280.jpg', null, '0', '0', '2016-03-21 11:51:33', '0');
INSERT INTO `edu_user` VALUES ('8', '13300009999', '23@test.com', '3d186804534370c3c817db0563f0e461', null, null, '0', '0', '2015-08-09 18:15:25', '1', '/images/upload/customer/20150512/6818.jpg', null, '0', '1', '0000-00-00 00:00:00', '0');
INSERT INTO `edu_user` VALUES ('9', '15612348458', '9162321458@qq.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-09-01 16:21:54', '1', null, null, '0', '1', '2015-09-01 16:21:54', '0');
INSERT INTO `edu_user` VALUES ('10', '15940037813', 'exmail@qq.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-09-09 15:35:12', '1', null, null, '0', '0', '2015-09-09 16:38:28', '0');
INSERT INTO `edu_user` VALUES ('11', '13161090128', '609682727@qq.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-09-10 09:39:14', '1', null, null, '0', '1', '2015-09-10 09:39:14', '0');
INSERT INTO `edu_user` VALUES ('12', '13161090120', '6096827271@qq.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-10-08 09:27:22', '1', null, null, '0', '1', '2015-10-08 09:27:22', '0');
INSERT INTO `edu_user` VALUES ('13', '13113131313', 'test@test.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-10-29 14:55:41', '1', null, null, '0', '1', '2015-10-29 14:55:41', '0');
INSERT INTO `edu_user` VALUES ('14', '13113132313', 'test@test1.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-10-29 18:41:04', '1', null, null, '0', '1', '2015-10-29 18:41:04', '0');
INSERT INTO `edu_user` VALUES ('15', '13664878797', 'qwer@qq.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-11-03 18:46:18', '1', null, null, '0', '1', '2015-11-03 18:46:18', '0');
INSERT INTO `edu_user` VALUES ('16', '13512121212', 'demo@zxy.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2015-11-09 15:33:38', '1', null, null, '0', '1', '2015-11-09 15:33:38', '0');
INSERT INTO `edu_user` VALUES ('66', '13520191388', 'qwe@qwe.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2016-01-30 17:50:13', '0', null, null, '0', '0', '2016-01-30 17:50:13', '0');
INSERT INTO `edu_user` VALUES ('67', '13520191382', 'qwe1@qwe.com', '96e79218965eb72c92a549dd5a330112', null, null, '0', '0', '2016-01-30 17:50:13', '0', null, null, '0', '0', '2016-01-30 17:50:13', '0');
...
-- ----------------------------
INSERT INTO `edu_website_images` VALUES ('274', '/images/upload/image/20181009/1539076902705.jpg', '/front/showcoulist', '首页banner图片01', '1', '1', '/images/upload/image/20150915/1442313369401.jpg', '#ef550f', '');
INSERT INTO `edu_website_images` VALUES ('284', '/images/upload/image/20181009/1539076913411.jpg', '/front/showcoulist', '首页banner图片02', '1', '2', '/images/upload/image/20150915/1442313577205.jpg', '#ef550f', '');
...
CREATE TABLE `edu_website_images_type` (
  ...
  PRIMARY KEY (`TYPE_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='图片类型表';
...
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='权限表';
...
INSERT INTO `sys_login_log` VALUES ('13', '2018-10-09 17:17:31', '192.168.0.97', '1', 'windows', 'chrome');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '96e79218965eb72c92a549dd5a330112', 'inxedu教育', '0', '2018-10-09 17:17:31', '192.168.0.97', '2015-03-17 01:45:46', 'inxedu@inxedu.com', '88888888888', '1');
